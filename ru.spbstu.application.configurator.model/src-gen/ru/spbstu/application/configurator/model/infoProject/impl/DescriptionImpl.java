...
public class DescriptionImpl extends MinimalEObjectImpl.Container implements Description
{
  ...
  {
    return InfoProjectPackage.Literals.DESCRIPTION;
  }
  ...
  public void setName(String newName)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, InfoProjectPackage.DESCRIPTION__NAME, oldName, name));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case InfoProjectPackage.DESCRIPTION__NAME:
        return getName();
    }
