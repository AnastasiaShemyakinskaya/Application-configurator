...
public class VersionImpl extends MinimalEObjectImpl.Container implements Version
{
  ...
  {
    return InfoProjectPackage.Literals.VERSION;
  }
  ...
  public void setName(String newName)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, InfoProjectPackage.VERSION__NAME, oldName, name));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case InfoProjectPackage.VERSION__NAME:
        return getName();
    }
