 ...
 * </p>
 * <ul>
 *   <li>{@link ru.spbstu.application.configurator.myDsl.Hold#getFeatures1 <em>Features1</em>}</li>
 *   <li>{@link ru.spbstu.application.configurator.myDsl.Hold#getFeatures <em>Features</em>}</li>
 * </ul>
 *
 * @see ru.spbstu.application.configurator.myDsl.MyDslPackage#getHold()
 * @model
 * @generated
 */
public interface Hold extends EObject
{
   ...
   * @see ru.spbstu.application.configurator.myDsl.MyDslPackage#getHold_Features1()
   ...
   * The list contents are of type {@link ru.spbstu.application.configurator.myDsl.HoldType}.
   * <!-- begin-user-doc -->
   * <p>
   ...
   * @see ru.spbstu.application.configurator.myDsl.MyDslPackage#getHold_Features()
   * @model containment="true"
   * @generated
   */
