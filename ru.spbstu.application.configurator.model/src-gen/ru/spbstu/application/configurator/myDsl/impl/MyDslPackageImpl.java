...
import ru.spbstu.application.configurator.myDsl.MyDslFactory;
...
public class MyDslPackageImpl extends EPackageImpl implements MyDslPackage
{
   ...
   * @generated
   */
  private EClass archiveTipeEClass = null;
   ...
   * @see ru.spbstu.application.configurator.myDsl.MyDslPackage#eNS_URI
   * @see #init()
   * @generated
   */
   ...
   * @generated
   */
  public EClass getArchiveTipe()
  {
    return archiveTipeEClass;
  }
   ...
   * @generated
   */
  public EAttribute getArchiveTipe_Name()
  {
    return (EAttribute)archiveTipeEClass.getEStructuralFeatures().get(0);
  }
  ...
  public void createPackageContents()
  {
    ...
    archiveTipeEClass = createEClass(ARCHIVE_TIPE);
    createEAttribute(archiveTipeEClass, ARCHIVE_TIPE__NAME);
  ...
  public void initializePackageContents()
  {
    ...
    initEReference(getApplication_Features(), this.getArchiveTipe(), null, "features", null, 0, -1, Application.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    ...
    initEClass(archiveTipeEClass, ArchiveTipe.class, "ArchiveTipe", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
    initEAttribute(getArchiveTipe_Name(), ecorePackage.getEString(), "name", null, 0, 1, ArchiveTipe.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    ...
    initEClass(mcsEClass, ru.spbstu.application.configurator.myDsl.MCS.class, "MCS", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
    initEAttribute(getMCS_Name(), ecorePackage.getEString(), "name", null, 0, 1, ru.spbstu.application.configurator.myDsl.MCS.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
